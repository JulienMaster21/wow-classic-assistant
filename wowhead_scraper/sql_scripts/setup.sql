...
-- Sun 12 Apr 2020 12:15:32 AM CEST
...
-- -----------------------------------------------------
-- Table `wow_classic_assistant`.`recipe_reagent`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wow_classic_assistant`.`recipe_reagent` (
...
-- -----------------------------------------------------
-- Table `wow_classic_assistant`.`character_profession`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wow_classic_assistant`.`character_profession` (
...
-- -----------------------------------------------------
-- Table `wow_classic_assistant`.`recipe_trainer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wow_classic_assistant`.`recipe_trainer` (
  `recipe_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `wow_classic_assistant`.`reagent_vendor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wow_classic_assistant`.`reagent_vendor` (
  `reagent_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `wow_classic_assistant`.`vendor_location`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wow_classic_assistant`.`vendor_location` (
  `vendor_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `wow_classic_assistant`.`character_recipe`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wow_classic_assistant`.`character_recipe` (
  `character_id` INT UNSIGNED NOT NULL,
  `recipe_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `wow_classic_assistant`.`reagent_source`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wow_classic_assistant`.`reagent_source` (
  `reagent_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `wow_classic_assistant`.`trainer_profession`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `wow_classic_assistant`.`trainer_profession` (
  `trainer_id` INT UNSIGNED NOT NULL,
  `profession_id` INT UNSIGNED NOT NULL,
